...
const Blog: React.FC = () => {
	return (
		<div className='blog-container'>
			...
			<p className='blog-subtitle'>Insights, news and stories from the world of books</p>
			...
			<div className='blog-grid'>
				...
				<div className='blog-card'>
					...
					<div className='blog-content'>
						...
						<p className='blog-card-text'>Simple strategies that help turn reading into a true passion.</p>
						<a className='blog-read-more'>Read More →</a>
					</div>
				</div>
				...
				<div className='blog-card'>
					...
					<div className='blog-content'>
						<h2 className='blog-card-title'>Interview with Award-Winning Author Daniel Ross</h2>
						<p className='blog-card-text'>
