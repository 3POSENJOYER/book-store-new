  ...
  return (
    <div className="blog-container">
      ...
      <div className="blog-grid">
        <div className="blog-card">
          ...
          <div className="blog-content">
            ...
            <p className="blog-card-text">
              We've hand-picked the most anticipated books that will reshape
              your reading list this year.
            </p>
        ...
        <div className="blog-card">
          <img
            src="src/modules/token/components/social/images/blog2.jpg"
            className="blog-img"
            alt="Library"
          />
          <div className="blog-content">
        ...
        <div className="blog-card">
          <img
            src="src/modules/token/components/social/images/blog3.jpg"
            className="blog-img"
            alt="Author"
          />
          <div className="blog-content">
            ...
            <p className="blog-card-text">
              Exclusive insights into his creative process and inspiration
              behind his latest bestseller.
            </p>
            <a className="blog-read-more">Read More →</a>
          </div>
        </div>
