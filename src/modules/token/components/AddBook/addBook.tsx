...
const AddBook: React.FC = () => {
	...
	return (
		<form onSubmit={handleSubmit} className='addBookForm'>
			...
			<label>
				productID:
				<input type='number' name='productID' value={bookInfo.productID || ''} onChange={handleChange} />
			</label>
			...
			<label>
				...
				{bookInfo.frontImg && <img className='preview' src={bookInfo.frontImg} alt='front preview' />}
			</label>

			<label>
				backImg:
				<input type='file' accept='image/*' name='backImg' onChange={handleImageChange} />
				{bookInfo.backImg && <img className='preview' src={bookInfo.backImg} alt='back preview' />}
			</label>
			...
			<label>
				year:
				<input type='number' name='year' value={bookInfo.year || ''} onChange={handleChange} />
			</label>

			<label>
				productPrice:
				<input type='number' name='productPrice' value={bookInfo.productPrice || ''} onChange={handleChange} />
			</label>

			<label>
				count:
				<input type='number' name='count' value={bookInfo.count || ''} onChange={handleChange} />
			</label>
